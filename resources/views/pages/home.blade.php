                    ...
                    <div class="booking-form">
                        ...
                        <form action="{{ route('rooms') }}" method="GET">
                            <div class="check-date">
                                ...
                                <input type="text" class="date-input" id="date-in" name="check_in" autocomplete="off">
                                <i class="icon_calendar"></i>
                            </div>
                            <div class="check-date">
                                <label for="date-out">Check Out:</label>
                                <input type="text" class="date-input" id="date-out" name="check_out" autocomplete="off">
                                <i class="icon_calendar"></i>
                            </div>
            ...
            <div class="hp-room-items">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="hp-room-item set-bg" data-setbg="{{ asset($room->image) }}">
                            <div class="hr-text">
                                <h3>{{ $room->name }}</h3>
